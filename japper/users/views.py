...
class UpdateUserProfile(GenericView):
    ...
    def get_forms(self, request, data=None):
        ...
        subscriptions = request.user.profile.subscriptions.split()
        subscriptions_form = UserSubscriptionsForm(
            data=data,
    ...
    def post(self, request):
        user_form, profile_form, subscriptions_form = self.get_forms(
            request,
            request.POST
        )
